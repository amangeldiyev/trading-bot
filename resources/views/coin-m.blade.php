                    ...
                    <div class="flex items-center justify-center">
                        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
                            ...
                            <div class="flex justify-center">
                                <div class="flex">
                                    <h1 class="text-gray-600 font-bold md:text-2xl text-xl p-2">Open COIN-M position</h1>
                                </div>
                            </div>

                            <form method="POST" action="{{ route('routeName', ['id'=>1]) }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                @csrf
                                <div class="mb-4">
