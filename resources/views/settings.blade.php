                    ...
                    <div class="flex items-center justify-center">
                        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
                            ...
                            <form method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
                                ...
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="hedge_scalp_enabled">
                                        Hedge scalp enabled
                                    </label>
                                    <input name="hedge_scalp_enabled" value="{{$hedge_scalp_enabled->value}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="price_difference_interval" type="text" placeholder="Price Interval">
                                </div>
