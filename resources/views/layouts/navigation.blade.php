<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('total-funding-rate')" :active="request()->routeIs('total-funding-rate')">
                Total funding rate
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('open')" :active="request()->routeIs('open')">
                Open position
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('close')" :active="request()->routeIs('close')">
                Close position
            </x-responsive-nav-link>
        </div>
